    ...
    <>
      <section className="w-full flex xl_flex-row justify center min-h-screen gap-10 max-container">
        <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
          ...
          <h3 className="text-4xl mt-10">
            Track, set goals, and unlock your financial potential—all in one
            place.
          </h3>
          <p className="text-gray-500 mt-10">
            From managing your daily expenses to reaching your long-term dreams,
            CashaBlanca is designed with you in mind. Dive into curated lessons,
            stay motivated with engaging challenges, and watch your financial
            growth story unfold.
          </p>
        ...
        <div className="relative flex-1 flex justify-end items-end xl:min-h-screen max-xl:py-40 bg-bottom bg-auto">
          <img
            src={landing}
            alt="Main Landing"
            className="object-contain relative z-10 object-right"
          />
        </div>
      </section>
      ...
      <section id="products" className="max-container max-sm:mt-12">
        <div className="flex flex-col justify-start gap-5">
          <h2 className="text-4xl font-palanquin font-bold">Our Features</h2>
