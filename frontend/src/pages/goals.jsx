  ...
  return (
    <>
      <div className="mb-4 flex flex-1 items-center justify-between">
        ...
        <button className="mr-6 rounded-xl bg-blue-400 px-4 py-2 text-white shadow-lg hover:bg-blue-700">
          Add Goals
        </button>
      </div>
          ...
          <div className="flex justify-center border-t bg-slate-100 p-5 text-gray-400">
            <div className="group">
              ...
              <div className="absolute mt-10 mx-12 transform -translate-x-1/2 z-10 px-4 py-2 rounded-md shadow-md text-white bg-gray-800 text-xs font-bold transition-all duration-150 scale-0 group-hover:scale-100">
                <p className="text-sm">
                  To achieve your goal in approximately 4 weeks:
                </p>
                <p className="text-sm">
                  - Save approximately $250.00 per week.
                </p>
