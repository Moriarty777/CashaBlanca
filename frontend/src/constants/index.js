export const navLinks = [
    { href: "dashboard", label: "Dashboard", iconName: "Gauge", iconColor: "#10b981", iconSize: 24},
    { href: "goals", label: "Goals",iconName: "Goal", iconColor: "#f97316", iconSize: 24},
...
export const questions = [
    ...
    { id: 3, question: 'What is the capital of Vatican?', options: ['Berlin', 'Madrid', 'Paris', 'Rome'], correctAnswer: 'Rome' },
